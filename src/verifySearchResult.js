...
function verifySearchResult(result) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let verified = null;
        while (verified === null) {
            const userSelection = (yield (0, utils_1.userInput)('Please verify (y/n): ')).toLowerCase();
...
exports.default = verifySearchResult;
//# sourceMappingURL=verifySearchResult.js.map